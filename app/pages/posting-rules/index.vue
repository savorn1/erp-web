<template>
  <div>
    <div class="flex items-center justify-between gap-3 mb-4">
      ...
      <UButton v-if="companyId" color="neutral" variant="soft" icon="i-lucide-sparkles" :loading="seeding" @click="onSeed"> Seed from standard chart </UButton>
    </div>
    ...
    <UCard class="mb-4">
      ...
      <p class="text-xs text-gray-400 mt-3">
        ...
        the standard chart of accounts first if the company doesn't have it yet — it never overwrites a field you've already mapped.
      </p>
    </UCard>
