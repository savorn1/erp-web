<template>
  <div>
    <ReportBackButton />
    <PageHeader
      title="Stock by serial number"
      description="Every individually-tracked unit currently in stock — same data as Serial Number Stock."
      :crumbs="[{ label: 'Reports', to: '/reports' }, { label: 'Inventory reports' }, { label: 'Stock by serial number' }]"
    />
    ...
    <UCard v-else>
      <DataTable :rows="rows" :columns="columns" exportable export-filename="inventory-stock-by-serial-number">
