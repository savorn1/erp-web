<template>
  <div>
    ...
    <PageHeader
      title="Detail"
      description="Every sold line, with unit price, discount, and tax broken out."
      :crumbs="[{ label: 'Reports', to: '/reports' }, { label: 'Sales reports' }, { label: 'Detail' }]"
    />
    ...
    <template v-else-if="detail">
      ...
      />
      <UCard>
        <DataTable :rows="detail.rows" :columns="columns" exportable export-filename="sales-detail">
