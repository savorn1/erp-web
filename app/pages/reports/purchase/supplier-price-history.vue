<template>
  <div>
    ...
    <UCard v-else>
      <EmptyState v-if="!supplierId" icon="i-lucide-history" title="Select a supplier" description="Choose a supplier above to see what's been paid to them over time." />
