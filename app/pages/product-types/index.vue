<template>
  <div>
    ...
    <UCard>
      ...
      >
        ...
        <template #empty-state>
          ...
          <EmptyState v-else icon="i-lucide-shapes" title="No types yet" description="Create the first type to get started.">
            <template #action>
    ...
    <UModal v-model:open="showCreate" title="New type">
      <template #body>
        <DynamicForm
          v-model="createForm"
          :fields="formFields"
