  ...
  <div>
    ...
    <UCard>
      <DataTable
        ...
        numbered
        exportable
        export-filename="customer-groups"
    ...
    <UModal v-model:open="showCreate" title="New customer group">
      <template #body>
        <DynamicForm
          v-model="createForm"
          :fields="formFields"
    ...
    <UModal v-model:open="showEdit" :title="`Edit group '${editingGroup?.name ?? ''}'`">
      <template #body>
        <DynamicForm
          v-model="editForm"
          :fields="formFields"
    ...
    <ConfirmModal
      ...
      title="Delete group"
      :description="`Delete group '${confirmDelete?.name ?? ''}'? This cannot be undone.`"
...
import type { CustomerGroup, CustomerGroupPayload } from '~/composables/useCustomerGroups'
...
const {
  ...
  showEdit, editing, editError, editingRow: editingGroup, editForm, openEdit, onEdit,
  deleting, confirmDelete, onDelete
} = useCrudModals<CustomerGroup, CustomerGroupPayload>(
  {
