  ...
  <div>
    ...
    >
      <div class="flex items-center gap-2 min-w-0">
        <UIcon :name="node.children.length > 0 ? 'i-lucide-folder' : 'i-lucide-file-text'" class="w-4 h-4 text-gray-500 dark:text-gray-400 shrink-0" />
        <span class="text-sm font-mono text-gray-500 dark:text-gray-400 shrink-0">{{ node.accountCode }}</span>
