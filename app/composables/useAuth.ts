...
export function useAuth() {
  ...
  // Cookie names are prefixed 'erp_' (rather than the generic 'auth_*')
  ...
  const token = useCookie<string | null>('erp_auth_token', { default: () => null, sameSite: 'lax' })
  const refreshToken = useCookie<string | null>('erp_auth_refresh_token', {
    default: () => null,
    sameSite: 'lax'
  })
  const username = useCookie<string | null>('erp_auth_username', {
    default: () => null,
    sameSite: 'lax'
  })
